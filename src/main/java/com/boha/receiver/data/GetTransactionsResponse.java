...
/*
    ...
    On success the endpoint should return 200 OK HTTP status code and a JSON object with the following fields:
        ...
        amount_in	                string	(optional) com.boha.money.data.Amount received by anchor at start of transaction as a string with up to 7 decimals. Excludes any fees charged before the anchor received the funds.
        amount_out	                string	(optional) com.boha.money.data.Amount sent by anchor to user at end of transaction as a string with up to 7 decimals. Excludes amount converted to XLM to fund account and any external fees.
        amount_fee	                string	(optional) com.boha.money.data.Amount of fee charged by anchor.
